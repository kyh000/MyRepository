 ...
 *  
 */
package io.netty.heatbeat;

import io.netty.channel.ChannelFutureListener;
import io.netty.channel.ChannelHandler.Sharable;
import io.netty.channel.ChannelHandlerAdapter;
import io.netty.channel.ChannelHandlerContext;
import io.util.HeatbeatMessage;
...
public class Server4HeatbeatHandler extends ChannelHandlerAdapter {
	...
	private static List credentials = new ArrayList<String>();
	...
	public Server4HeatbeatHandler(){
		...
		credentials.add("192.168.232.1_DESKTOP-PPIMFTC");
		credentials.add("192.168.50.45_DESKTOP-RKF19IK");
	}
